...
def generate_retention_email(
    ...
    Returns dict: subject, preview, body, tone, target_segment
    """
    ...
    if signal_type == "price_change" and pct_change is not None:
        ...
        return {
            ...
            "preview": f"A calm retention email for customers comparing {competitor_name}'s new pricing.",
            "body": (
                f"Hi {{{{customer_name}}}},\n\n"
            ...
            "tone": "calm, confident, value-focused",
    ...
    if signal_type in ("news_mention", "feature_launch"):
        return {
            ...
            "preview": f"A proactive update for customers after {competitor_name} made news.",
            "body": (
                f"Hi {{{{customer_name}}}},\n\n"
    ...
    return {
        ...
        "preview": "A brief update on how we're staying ahead for you.",
        "body": (
            f"Hi {{{{customer_name}}}},\n\n"
